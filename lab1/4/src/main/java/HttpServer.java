...
class HttpServer {
    ...
    private void process(Request request, Response response) throws IOException {
        ...
        if (file.isFile()) {
            ...
            /* https://ruhighload.com/%D0%9A%D0%B5%D1%88%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5+%D1%81+http+etag */
            String etag = getEtag(file);
            response.setHeader("ETag", etag);
            if (etag.equals(request.getHeaders().get("If-None-Match"))) {
    ...
    private String getEtag(File file) {
        return Integer.toString(Arrays.hashCode(new String[]{file.lastModified() + Long.toString(file.length())}));
    }
    ...
    private static final class Request {
        ...
        private boolean haveHeader(String name) {

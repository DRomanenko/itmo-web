...
import ru.itmo.wp.form.validator.ToggleDisabledValidator;
...
public class UsersPage extends Page {
    ...
    public String toggleDisabled(@Valid @ModelAttribute("toggleDisabledForm")ToggleDisabledForm toggleDisabledForm,
        ...
        if (userService.findById(toggleDisabledForm.getId()) == null) {
            putMessage(httpSession, "Hello");
        ...
        userService.updateDisabled(toggleDisabledForm);
        return "redirect:/users/all";
    }
}

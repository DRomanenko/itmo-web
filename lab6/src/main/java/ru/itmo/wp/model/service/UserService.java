...
public class UserService {
    ...
    public void validateAdmin(long id) throws ValidationException {
        User user = userRepository.find(id);
        if (user == null) {
            throw new ValidationException("Invalid request user id");
        }
        if (!user.isAdmin()) {
            throw new ValidationException("Request user id does not have permission to set admin");
        }
    }
